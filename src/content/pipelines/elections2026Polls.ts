...
python seed_party_aliases.py`,
    ...
    },
    {
      ...
      paragraphs: [
        'בסוף ריצה מוצלחת (לא dry-run) שבה נכנסו סקרים חדשים, הצינור קורא לכלי המשותף לעדכוני האתר. מודל שפה כותב כותרת עברית קצרה אחת מנתוני השינוי, והכותרת נשמרת לפס החדשות בדף הבית עם קישור לעמוד הסקרים.',
