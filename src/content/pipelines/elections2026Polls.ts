...
python seed_party_aliases.py`,
    ...
    },
    {
      ...
      paragraphs: [
        'שלב 7 בצינור (יצירת עדכון) קורא לכלי המשותף לעדכוני האתר כשיש סקרים חדשים. מודל שפה כותב כותרת עברית קצרה אחת מנתוני השינוי, והכותרת נשמרת לפס החדשות בדף הבית עם קישור לעמוד הסקרים.',
        'בממשק העריכה אפשר לראות את הכותרת שנוצרה, לערוך אותה ולשמור מחדש. ריצות CLI/מתוזמנות ממשיכות לפלוט את העדכון אוטומטית בסוף ריצה מוצלחת עם סקרים חדשים.',
        'אם אין סקרים חדשים, או אם יצירת הכותרת נכשלת — אין כתיבה לפס החדשות; הצינור עצמו ממשיך כרגיל.',
      ],
    },
  ],
}
