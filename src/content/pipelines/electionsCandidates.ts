...
OPENAI_API_KEY=...`,
    ...
    },
    {
      ...
      paragraphs: [
        'בסוף ריצת הצינור (או אחרי שלב 1 / אישור תור בדיקה בממשק העריכה) שבה נוספו מועמדים חדשים, הצינור קורא לכלי המשותף לעדכוני האתר.',
        'מודל שפה כותב כותרת עברית קצרה אחת מנתוני המועמדים החדשים, והכותרת מופיעה בפס החדשות בדף הבית עם קישור לעמוד הבחירות. בלי מועמדים חדשים או בכשל ביצירת הכותרת — אין כתיבה לפס.',
      ],
    },
  ],
}
