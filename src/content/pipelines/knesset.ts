...
python sync_knesset_data.py --probe`,
    ...
    },
    {
      ...
      paragraphs: [
        'בסיום שלב החברויות והמינויים (או סנכרון מלא), הצינור משווה את מצב החברויות והמינויים לפני ואחרי. אם יש שינוי ממשי (תפקיד חדש, סיום תפקיד, שינוי תיאור), נשלחים נתוני השינוי לכלי המשותף לעדכוני האתר.',
        'מודל שפה כותב כותרת עברית קצרה אחת, והיא מופיעה בפס החדשות בדף הבית עם קישור לעמוד הכנסת. בלי שינוי אמיתי או בכשל ביצירת הכותרת — אין כתיבה לפס; הסנכרון עצמו לא נפגע.',
      ],
    },
  ],
}
