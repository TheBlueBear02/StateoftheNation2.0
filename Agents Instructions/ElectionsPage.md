...
| `src/components/elections/dream/DreamOfficeSquare.tsx` | Empty (+) or filled office/PM square; office title above the portrait, person name then party short name under it |
