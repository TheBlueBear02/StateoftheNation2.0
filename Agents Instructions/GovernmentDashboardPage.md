...
- Homepage teaser: `SHOW_GOVERNMENT_DASHBOARD = true` in `App.tsx`, links to `/government/dashboard`; preview is `DashboardHomePreview` (each quarter = one office’s 3 indexes + minister).
