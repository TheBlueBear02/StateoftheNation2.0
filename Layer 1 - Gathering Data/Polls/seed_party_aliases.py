...
ALIASES = [
    ...
    {"raw_label": "Reserv.", "short_name": "המילואימניקים"},
    {"raw_label": "Reserv", "short_name": "המילואימניקים"},
    {"raw_label": "Hadash –Ta'al", "short_name": 'חד"ש תע"ל'},
    {"raw_label": "Hadash – Ta'al", "short_name": 'חד"ש תע"ל'},
    {"raw_label": "Hadash– Ta'al", "short_name": 'חד"ש תע"ל'},
    ...
    {"raw_label": "Reservists", "short_name": "המילואימניקים"},
    {"raw_label": "Reservists on Duty", "short_name": "המילואימניקים"},
    {"raw_label": "Reserv. - NEP", "short_name": "המילואימניקים"},
    {"raw_label": "Reserv.–NEP", "short_name": "המילואימניקים"},
    {"raw_label": "Reserv. – NEP", "short_name": "המילואימניקים"},
    # 2026 wiki columns that blocked ingest after Aug 2026 table redesign
    {"raw_label": "Amcha Yisrael", "short_name": "עמך ישראל"},
    {"raw_label": "Amcha Israel", "short_name": "עמך ישראל"},
