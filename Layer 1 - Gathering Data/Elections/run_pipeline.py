...
Usage:
  ...
  python run_pipeline.py --stage 1      # run one stage only (1–4)
  python run_pipeline.py --skip-enrich  # skip Wikidata (if already enriched)
...
def main():
    ...
    parser.add_argument("--skip-enrich",  action="store_true", help="Skip Wikidata enrichment")
